...
//
//  Created by Yejin on 2023/02/10.
...
class ObjectDetectionMain : ViewController {
    ...
    func setupLayers() {
        ...
        print("BOX", rootLayer.bounds.midX, rootLayer.bounds.midY, bufferSize.width, bufferSize.height)
    ...
    func updateLayerGeometry() {
        ...
        let xScale: CGFloat = bounds.size.width / bufferSize.height //bufferSize.height
        let yScale: CGFloat = bounds.size.height / bufferSize.width //bufferSize.width
